...
For a source file `BUR-K/M1324399-DOC_MP44_MAIN-REV_E.pdf`, the orchestrator writes:

```
BUR-K/kb/M1324399-DOC_MP44_MAIN-REV_E/
...
1. `kb extract C:\Users\xumax\AI Project\Private\BUR-K` produces `BUR-K\kb\M1324399-DOC_MP44_MAIN-REV_E\` with `main.md`, `index.json`, `meta.json`, populated `assets/`, all H3..H12 satisfied.
